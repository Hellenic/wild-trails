...
import { ROLE_INFO, type GameRole as RoleType } from "@/lib/game/roles";
      ...
      {isMultiplayer && (
        <div>
          ...
          <div className="space-y-2">
            ...
            {(() => {
              let rolesToShow: RoleType[] = [];
              
              if (formData.playerCount === 2) {
                if (formData.gameMasterType === "ai") {
                  // 2-player with AI GM: show player_a and player_b
                  rolesToShow = ["player_a", "player_b"];
                } else {
                  // 2-player with Player GM: show player_a and game_master
                  rolesToShow = ["player_a", "game_master"];
                }
              } else if (formData.playerCount === 3) {
                // 3-player: show all roles
                rolesToShow = ["player_a", "player_b", "game_master"];
              }
